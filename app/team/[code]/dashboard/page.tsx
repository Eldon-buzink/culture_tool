                      ...
                      <div key={member.id} className="border border-gray-200 rounded-lg p-4">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">vs Team Average</p>
                          </div>
                        </div>
                        ...
                        <div className="mb-4">
                          ...
                          {/* Gap Analysis */}
                          <div className="mt-4">
                            <h6 className="font-medium text-gray-900 mb-2">Key Differences:</h6>
                            <div className="space-y-2">
                              {Object.entries(member.oceanScores!).map(([trait, score]) => {
                                const teamScore = teamData.aggregateScores.ocean[trait];
                                const difference = score - teamScore;
                                const isSignificant = Math.abs(difference) > 15;
                        ...
                        <div className="mb-4">
                          <h5 className="font-medium text-gray-900 mb-3 flex items-center gap-2">
                            <Globe className="h-4 w-4" />
                            Cultural Work Style Comparison
                          </h5>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <RadarChart
                              data={member.cultureScores!}
                              title={`${member.name}'s Culture`}
                              color="#8B5CF6"
                              size={300}
                            />
                            <RadarChart
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <RadarChart
                              data={member.valuesScores!}
                              title={`${member.name}'s Values`}
                              color="#EF4444"
                              size={300}
                            />
                            <RadarChart
